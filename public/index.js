    ...
    for (i = 0; i < input.length; i++) {
      ...
      load
        ...
        .then(() => {
          ...
          //patient info
          patientInfo.patientID = series[0].patientID;
          patientInfo.patientName = series[0].patientName;
          patientInfo.seriesDescription = series[0].seriesDescription;
          patientInfo.studyDate = series[0].studyDate;
          patientArr.push(patientInfo);
          DisplayPatientInfo();
...
function DisplayPatientInfo() {
  let element = $("#patientInfo");
  element.html("");
  let info = "";
  info += `<p>Patient ID: ${patientArr[0].patientID}</p>`;
  info += `<p>Patient Name: ${patientArr[0].patientName}</p>`;
  info += `<p>Series description: ${patientArr[0].seriesDescription}</p>`;
  info += `<p>Study date: ${patientArr[0].studyDate}</p>`;
  element.append(info);
}
